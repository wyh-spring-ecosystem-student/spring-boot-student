...
@SpringBootTest
public class SpringBootStudentSentinelApplicationTests {

    private static final Logger logger = LoggerFactory.getLogger(SpringBootStudentSentinelApplicationTests.class);
