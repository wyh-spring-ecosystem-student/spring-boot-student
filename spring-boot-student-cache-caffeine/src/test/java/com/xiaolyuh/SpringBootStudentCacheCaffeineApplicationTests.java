...
@SpringBootTest
public class SpringBootStudentCacheCaffeineApplicationTests {

    private static final Logger logger = LoggerFactory.getLogger(SpringBootStudentCacheCaffeineApplicationTests.class);
